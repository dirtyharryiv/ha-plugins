...
export REPO_URL=https://github.com/dirtyharryiv/ha-plugins
export NEXT_REPO_URL=https://github.com/dirtyharryiv/ha-plugins-next
export NEXT_REPO_SSH=git@github.com:dirtyharryiv/ha-plugins-next.git
